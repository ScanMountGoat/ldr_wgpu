...
pub mod bind_groups {
    ...
    pub struct BindGroupLayout0<'a> {
        ...
        pub workgroup_sums: wgpu::BufferBinding<'a>,
    }
                ...
                .create_bind_group(
                    &wgpu::BindGroupDescriptor {
                        ...
                        entries: &[
                            ...
                            wgpu::BindGroupEntry {
                                binding: 1,
                                resource: wgpu::BindingResource::Buffer(bindings.output),
                            },
                            wgpu::BindGroupEntry {
                                binding: 2,
                                resource: wgpu::BindingResource::Buffer(
                                    bindings.workgroup_sums,
                                ),
                            },
                        ],
                        label: None,
...
pub fn create_shader_module(device: &wgpu::Device) -> wgpu::ShaderModule {
    let source = std::borrow::Cow::Borrowed(include_str!("scan.wgsl"));
    device
